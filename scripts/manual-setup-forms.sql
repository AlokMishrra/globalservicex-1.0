-- Manual setup script for forms tables
...
SELECT 'Forms table created successfully' as status;
SELECT 'Form_submissions table created successfully' as status;
SELECT 'Sample forms inserted successfully' as status;
